...
int test_vector_manipulation() {
    ...
    test_assert(fabs(VECTOR(diff, 0) + 3.0) < NN_TYPE_EPSILON, "vector_subtraction correctly subtracts first elements, actual = %f", VECTOR(diff, 0));
    test_assert(fabs(VECTOR(diff, 2) + 3.0) < NN_TYPE_EPSILON, "vector_subtraction correctly subtracts last elements");
